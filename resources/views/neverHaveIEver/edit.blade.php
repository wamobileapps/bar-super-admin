					...
					<div class="side-app">
						<div class="page-header">
							...
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Edit Never Have I Ever</li>
							</ol>
						</div>
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Edit Never Have I Ever</h3>
									</div>

									<div class="card-body">
										<form action="{{ route('NeverHaveEver.update', $question->id) }}" method="post" enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="questions" value="{{ $question->questions }}" placeholder="Enter Never Have I Ever">
