		...
		overflow: auto;
				...
				<div class="app-content  toggle-content">
					<div class="side-app">
						...
						<!-- <td><?php// echo ucfirst('event_id'); ?></td> --> 
										...
										<table id="example" class="table display table-bordered" style="width:100%">
											        <thead>
											            <tr>
															...
															<th><?php echo ucfirst('icon'); ?></th> 
															<th><?php echo ucfirst('image'); ?></th> 
															<th><?php echo ucfirst('color'); ?></th> 
															<th><?php echo ucfirst('event type'); ?></th> 
															<th><?php echo ucfirst('start date'); ?></th> 
															<th><?php echo ucfirst('end date'); ?></th>
											        ...
											        <tbody>
											            ...
											            <tr>
											                ...
											                <td><a onclick="return confirm('Are you sure delete this data')" href="<?php echo url('User/deleteUserEvent', $event->id); ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a></td>
											            </tr>
											            <?php $a++; ?>
														@endforeach
														@endif
