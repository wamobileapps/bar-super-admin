							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Edit Questions</h3>
									</div>
											...
											<div class="row">
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="questionnaire_title" value="{{ $question->questionnaire_title }}" placeholder="Questionnaire Title">
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="first_question" value="{{ $question->first_question }}" placeholder="First Question">
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="sec_question" value="{{ $question->sec_question }}" placeholder="second Question">
