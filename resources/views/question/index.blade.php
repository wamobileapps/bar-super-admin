					...
					<div class="side-app">
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12">
								...
								<h3 style="float: right;"><a  class="btn btn-md btn-success" href="{{url('question/create')}}">Add</a></h3>
							</div>
							<div class="card">
                                    ...
                                    <table id="example" class="table display table-bordered" style="width:100%">
												...
												@forelse ($questions as $question)
													<tr>
                                                    	...
                                                    	<td>{{ $question->sec_question }}</td>
                                                        <td><a href="{{ route('question.edit', $question->id) }}" class=" mb-2 btn btn-sm btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;
														<a onclick="formSubmit({{$question->id}})" href="" class=" mb-2 btn btn-sm btn-danger"><i class="fa fa-trash"></i></a></td>
