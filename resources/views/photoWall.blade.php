										...
										<table id="example" class="table display table-bordered" style="width:100%">
											        ...
											        <tbody>
											            ...
											            <tr>
											                ...
											                <td><a onclick="return confirm('Are you sure delete this data')" href="<?php echo url('Bar/deleteBarphotoWall', $photowall->id); ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a></td>
											            </tr>
											            <?php $a++; ?>
														@endforeach
														@endif
