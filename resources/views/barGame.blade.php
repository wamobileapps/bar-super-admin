					...
					<div class="side-app">
						<div class="page-header">
							...
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Bar Game</li>
							</ol>
						</div>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12">
								<h3 class="card-title" style="float: left;">Bar Game</h3>
								<h3 style="float: right;"><a  class="btn btn-md btn-success" href="<?php echo url('Bar/addBarGame', $data->bar_id); ?>">Add</a></h3>
							</div>
							<div class="card">
								<div class="card-body">
										...
										<table id="example" class="table display table-bordered" style="width:100%">
											        ...
											        <tbody>
											            ...
											            <tr>
											                ...
											                <td><a href="<?php echo url('Bar/editBarGame', $game->id); ?>" class="btn btn-sm btn-warning mb-2"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> &nbsp;&nbsp; <a onclick="return confirm('Are you sure delete this data')" href="<?php echo url('Bar/deleteBarGame', $game->id); ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a></td>
											            </tr>
											            <?php $a++; ?>
														@endforeach
														@endif
