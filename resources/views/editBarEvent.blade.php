							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Edit Bar Event</h3>
									</div>

									<div class="card-body">
										<form action="{{url('Bar/BarEventUpdate', $data->event_id)}}" method="post" enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="name" value="<?php echo empty(old('name'))?$data->name:old('name');?>" placeholder="Name">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="color" value="<?php echo empty(old('color'))?$data->color:old('color');?>" placeholder="Color">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="event_type" value="<?php echo empty(old('event_type'))?$data->event_type:old('event_type');?>" placeholder="Event Type">
												...
												<div class="col-md-6">
													...
													<label class="form-label">Date of Event</label>
														<input type="date" class="form-control" name="start_date" value="<?php echo empty(old('start_date'))?$data->start_date:old('start_date');?>" placeholder="Start Date">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="time" class="form-control" name="start_time" value="<?php echo empty(old('start_time'))?$data->start_time:old('start_time');?>" placeholder="Start Time">
											...
											<!-- 	<div class="col-md-6">
													<div class="form-group">
														...
														<input type="date" class="form-control" name="end_date" value="<?php echo empty(old('end_date'))?$data->end_date:old('end_date');?>" placeholder="End Date">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="time" class="form-control" name="end_time" value="<?php echo empty(old('end_time'))?$data->end_time:old('end_time');?>" placeholder="End Time">
