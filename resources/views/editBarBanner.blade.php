				...
				<div class="app-content  toggle-content">
					<div class="side-app">
						<div class="page-header">
							<h4 class="page-title">Bar Edit</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="<?php echo url('Bar/barsDetails', 1); ?>">Bar Details</a></li>
								<li class="breadcrumb-item active" aria-current="page">Add Bar Edit</li>
							</ol>
						</div>
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<h3 class="mb-0 card-title">Add Bar Edit</h3>
									</div>
<!-- {{print_r($data)}} -->
									<div class="card-body">
										<form action="{{url('Bar/barBannerUpdate', $data->id)}}" method="post" enctype="multipart/form-data">
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="date" class="form-control" name="start_date" value="{{ $data->start_date }}" placeholder="Start Date">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="date" class="form-control" name="expiry_date" value="{{ $data->expiry_date }}" placeholder="Expaire Date">
